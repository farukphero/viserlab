        ...
        <div className="flex justify-center gap-x-10  mr-[150px] ">
          <div className="w-80">
            ...
            <p className="text-sm text-gray-600 leading-relaxed text-right">
              After gaining a deep understanding of your needs, We work closely
              with you, crafting tailored proposals and transparent deal that
      ...
      <div className="w-[650px] mx-auto">
        <div className="flex justify-center gap-x-10">
          ...
          <div className="w-72">
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              Once the deal is finalized, our expert team leverages technical
              prowess and industry insights to develop innovative solutions that
              precisely cater to your requirements, keeping you involved

      ...
      <div className="mt-20 lg:mt-0 lg:my-20 lg:w-[85%] lg:mx-auto mx-5">
        <div className="lg:w-8/12 mx-auto mb-24">
          ...
          <p className="mt-10 text-center lg:mx-6">
            ...
            expert consultancy, we deliver custom solutions to drive your
            digital success.
          </p>
        </div>
        <div className="grid grid-cols-4 gap-5">
          ...
          <div className="flex flex-col gap-5  mt-10">
            {/* 1 st  */}
            <Link href="/category/php-scripts" className="p-5 border">
            ...
            {/* 2nd  */}
            <Link href="/hosting/premium" className="p-5 border">
              <div className="flex justify-center">
            ...
            {/* 3rd  */}
            <Link href="/marketing/backlink" className="p-5 border">
              <div className="flex justify-center">
                <Image
                  src={back_link}
                  alt="course image"
              ...
              <p className="text-center">
                Quality backlink services to improve website visibility and
          ...
          <div className="flex flex-col gap-5  -mt-10">
            {/* 1 st  */}
            <Link href="/category/mobile-apps" className="p-5 border">
              <div className="flex justify-center">
            ...
            {/* 2nd  */}
            <Link href="/hosting/vps" className="p-5 border">
              <div className="flex justify-center">
            ...
            {/* 3rd  */}
            <Link href="/marketing/press-release" className="p-5 border">
              <div className="flex justify-center">
          ...
          <div className="flex flex-col gap-5  mt-14">
            {/* 1 st  */}
            <Link href="/category/html-templates" className="p-5 border">
              <div className="flex justify-center">
            ...
            {/* 2nd  */}
            <Link href="/hosting/dedicated" className="p-5 border">
              <div className="flex justify-center">
                <Image
                  src={dedicated}
                  alt="course image"
            ...
            {/* 3rd  */}
            <Link href="/marketing/advertising" className="p-5 border">
              <div className="flex justify-center">
              ...
              <p className="text-center">
                Comprehensive strategies to promote businesses online and
          ...
          <div className="flex flex-col gap-5  -mt-11">
            {/* 1 st  */}
            <Link href="/category/wordpress" className="p-5 border">
              <div className="flex justify-center">
                <Image
                  src={wordpress}
                  alt="course image"
            ...
            {/* 2nd  */}
            <Link href="/hosting/smtp" className="p-5 border">
              <div className="flex justify-center">
            ...
            {/* 3rd  */}
            <Link href="/marketing/branding" className="p-5 border">
              <div className="flex justify-center">
                <Image
                  src={branding}
                  alt="course image"
